...
public class TestDatamodel {
	...
	public static void main(String[] args) {
		...
		mcqanswer.setOption1("It is defined by 3 main descriptions : Name, State, Behavior");
		mcqanswer.setOption2("red");
		mcqanswer.setOption3("blue");
		mcqanswer.setOption4("green");
